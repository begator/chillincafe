...
(function() {
  ...
  const element = document.querySelector('.some-element'); // السطر 35
  console.log(element); // هذا سيساعدك على رؤية إذا كان العنصر موجودًا
  if (element) {
      element.addEventListener('click', function() {
          console.log('Element clicked!');
      });
  } else {
      console.error('Element not found: .some-element');
  }
